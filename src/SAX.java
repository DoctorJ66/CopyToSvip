...
public class SAX {
    ...
    public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException {
        ...
        parser.parse(new File("C:/Users/John/IdeaProjects/Copy To Svip/src/resources/DistFolderToCopy.xml"), handler);

    }

    public void print(String path) throws ParserConfigurationException, SAXException, IOException {
        SAXParserFactory factory = SAXParserFactory.newInstance();
        SAXParser parser = factory.newSAXParser();
        ...
        System.out.println("SAX is running");
